...
mixin _$AdMobStore on AdMobStoreBase, Store {
  ...
  @override
  String? get bannerAdUnitId => (_$bannerAdUnitIdComputed ??= Computed<String?>(
          () => super.bannerAdUnitId,
          name: 'AdMobStoreBase.bannerAdUnitId'))
      .value;
  Computed<String?>? _$nativeAdUnitIdComputed;

  @override
  String? get nativeAdUnitId => (_$nativeAdUnitIdComputed ??= Computed<String?>(
          () => super.nativeAdUnitId,
